    ...
    <div ref={showDivRef} className="addproducts__container">
      <div className="left-side">
        <div className="check-out-container">
          <div className="check-out-print">
            <h1 className="check-out-title">FACTURA</h1>
            {/* <p>{curDate}</p> */}
            <table>
              <thead>
                <tr>
                  <th>No.</th>
                  <th className="table-item-title">NOMBRE DEL PRODUCTO</th>
                  <th>PRECIO</th>
                  <th>CANTIDAD</th>
                </tr>
              </thead>
      ...
      <div className="right-side">
        <div className="right-side-header">
          <h1>
            CARRITO <span className="total-items">{items.length}</span>
            {items.length <= 1 ? " lIBRO" : " LIBROS"}
          </h1>
          <button
